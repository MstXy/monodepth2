...
'''
kitti_flow_dir = '/home/liu/AD_Data/DiFint/win_id4_share/KITTI/scene_flow_2015'  # TODO important path
    ...
    class Evaluation_bench():
        ...
        def __call__(self, test_model: tools.abs_test_model):
            ...
            while batch is not None:
                ...
                toshow = Image.fromarray((im1*255).cpu().squeeze().permute(1, 2, 0).numpy().astype(np.uint8))
                toshow.show()
                num = im1.shape[0]
