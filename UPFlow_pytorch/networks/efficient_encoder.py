...
from monodepth2.networks.efficientnet_pytorch.utils import *
import numpy as np
...
class EfficientEncoder(nn.Module):
    def __init__(self, valid_models='efficientnet-b0', pretrained=True):
        ...
        model = EfficientNet.from_name(valid_models, image_size=[192, 640], include_top=False)
