...
def dilated_resnet18(pretrained=False, **kwargs):
    ...
    """
    model = DilatedResNet(BasicBlock, [2, 2, 2, 2], deep_base=False, **kwargs)
    if pretrained:
...
def dilated_resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DilatedResNet(BasicBlock, [3, 4, 6, 3], deep_base=False, **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet34']))
    return model


def dilated_resnet50(pretrained=False, root='~/.encoding/models', **kwargs):
...
def dilated_resnet101(pretrained=False, root='~/.encoding/models', **kwargs):
