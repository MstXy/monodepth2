...
from networks.efficientvit.apps.trainer import Trainer
from networks.efficientvit.apps.utils import AverageMeter, sync_tensor
from networks.efficientvit.clscore.trainer.utils import accuracy, apply_mixup, label_smooth
from networks.efficientvit.models.utils import list_join, list_mean, torch_random_choices
